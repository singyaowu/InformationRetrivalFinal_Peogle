...
common_words = set(["馬上", "連結", "高調", "高雄", "高雄市","高市", "方式", "許多", "謝罪", "方向", "紀錄", "連鎖",
 "周一", "周二", "周三","白熱化", "周年","高雄人", "周四","周五","周六","周日", "週一","週二", "週三", "週四", "週五", "週六", "週日", "周邊", "顏色", "金屬", "紀念", "連忙", "連身裙",
  "施政","施壓","高挑","金錢","蕭條","沈重","高竿", "羅馬", "董事會","藍營","簡單","許許多多", "簡易",'嚴重', "嚴重性","高官","高於","高達","高樓","高額","馬尾","高出","王子","黃色","藍色","連署書","陸續","高中","周圍","高效能", "曾經", "歐洲","馬來西亞", "陸軍","遊走","施行", "白皙", "金融", "夏日","方案","程度", "白紙", "藍綠", "高級","白吃" "馬來西亞", "簡直", "高人氣", "馬路", "高速","施工","白色",
  "石油","簡訊", "嚴重",'簡體字','高興',"謝絕","謝謝","張貼","簡短","唐人", "金額", "游泳","林口","高度", "施放", "白宮","歐盟", "歐美", "白人","方針", "連播","高層","董事長","董事",'高市民調', "連署", "陸海","白皮書","藍天","程序","高喊", "蕭條","嚴苛", "高薪","鄭重","連任","紀念展", "陸委會", "尤其", "田徑", "田徑隊", "高血壓", "陸生", "陸客", "童裝", "連續", "連夜", "高學歷", "方面", "高等", "夏天", "方法", "顏值", "金字塔"])

titles = set(["先生", "小姐", "市長","總召","醫","局長","妻", "處長","國","市府","表明","解釋", "總統", "董事長","案", "立委", "粉", "小弟弟", "小妹妹", "議員", "姓", "姓男子","姓男", "姓女", "男", "女","男妻子","女先生", "姓女子", "姓少年", "姓少女","婦", "老先生", "揆", "閣揆", "政府", "網友"])
