...
parser.add_argument("-c", "--corpus_file", default="../data/data.json", dest="corpus_file", help="Pass in a .csv file.")
...
with open("../data/TF.json", "w", encoding="utf-8") as f:
    json.dump(TF, f, ensure_ascii=False)
with open("../data/INV_FILE.json", "w", encoding="utf-8") as f:
    json.dump(INV_FILE, f, ensure_ascii=False)
with open("../data/DOC_LENGTH.json", "w", encoding="utf-8") as f:
