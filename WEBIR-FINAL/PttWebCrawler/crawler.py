...
class PttWebCrawler(object):
    ...
    def parse_articles(self, start, end, board, path='.', timeout=30):
            ...
            for i in range(end-start+1):
                ...
                for div in divs:
                    ...
                    if title is not None:
                        if not re.match(r"Re:", title.text) and "[新聞]" in title.text:
                            print(title.text)
                            try:
    ...
    @staticmethod
    def parse(link, article_id, board, timeout=30):
